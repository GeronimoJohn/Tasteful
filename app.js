const client = contentful.createClient({
    ...
    accessToken: "AhTMGjIGx1nflRAs-lxRR0bcD-osLEk-DQqKeIKLqJs"
});
...
// All the buttons from the products will go in here
let buttonsDOM = [];

// Class for getting the products
class Products {
    // Method to get the files from the contenful cms
    async getProducts(){
        try {
            let contentful = await client.getEntries({
                content_type: 'tasteful'
            });
...
// Class for displaying the products
class UI {
    ...
    addCartItem(item){
        ...
        div.innerHTML = `<img src=${item.image} alt="product">
            ...
            <div>
                ...
                <p class="item-acount">${item.amount}</p>
